...
(function (window) {
    ...
    var httpApi = (environment == 'www') ? 'http://web.delicloud.com' : ((environment == 'test') ? 'http://t.delicloud.com' : ((environment == '202') ? 'http://192.168.0.202' : 'http://192.168.0.201'));
    /**
     *    deli.config 配置签名对象
     *    deli.ready 初始化完成
     *    deli.error 权限校验失败时
            ...
            prefixLoadTpl: function (userid, token) {
                ...
                var _WrapPrivate = {
                    ...
                    init: function () {
                        ...
                        .deli-wrap-header #deli-head .deli-logo-box .deli-logo{display: inline-block; float: left; width: 178px; height: 50px; line-height: 50px; margin: 15px 0;background-image: url(http://t.static.delicloud.com/www/home/images/logo.png?v=20180317); background-repeat: no-repeat; background-size: cover;}\
                        ...
                        .deli-footer-link dl.deli-attus .deli-icon-weixin-img{display:none;position:absolute;top:-80px;left:-25px;background-image:url(http://t.static.delicloud.com/www/home/images/weixin.png);width:80px;height:80px}\
